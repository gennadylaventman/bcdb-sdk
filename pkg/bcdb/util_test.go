...
func openUserSessionWithQueryTimeout(t *testing.T, bcdb BCDB, user string, tempDir string, queryTimeout time.Duration, clientTLS bool) DBSession {
	session, err := openUserSessionWithQueryTimeoutRaw(bcdb, user, tempDir, queryTimeout, clientTLS)
	require.NoError(t, err)
	return session
}

func openUserSessionWithQueryTimeoutRaw(bcdb BCDB, user string, tempDir string, queryTimeout time.Duration, clientTLS bool) (DBSession, error) {
...
func createDBInstance(t *testing.T, cryptoDir string, serverPort string) BCDB {
	return createDBInstanceWithTLSConfig(t, cryptoDir, serverPort, false, updateClientTLSConfigCorrect)
}

func createDBInstanceWithTLS(t *testing.T, cryptoDir string, serverPort string) BCDB {
	return createDBInstanceWithTLSConfig(t, cryptoDir, serverPort, true, updateClientTLSConfigCorrect)
}

func createDBInstanceWithTLSConfig(t *testing.T, cryptoDir string, serverPort string, tlsEnabled bool, updateClientConfig updateClientTLSConfig) BCDB {
	...
	updateClientConfig(t, cryptoDir, serverPort, conf, tlsEnabled)
...
type updateClientTLSConfig func(t *testing.T, cryptoDir, serverPort string, conf *sdkconfig.ConnectionConfig, tlsEnabled bool)

func updateClientTLSConfigCorrect(t *testing.T, cryptoDir, serverPort string, conf *sdkconfig.ConnectionConfig, tlsEnabled bool) {
	if tlsEnabled {
